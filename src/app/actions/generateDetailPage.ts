  ...
  try {
    ...
    const generation = await prisma.generation.create({
      data: {
        ...
        sellingPoints: JSON.stringify(params.coreSellingPoints),
        resultUrls: '[]',
        sceneImageUrls: '[]',
        detailImageUrls: '[]',
        ...
        await prisma.$transaction(async (tx) => {
          ...
          await tx.generation.update({
            ...
            data: {
              ...
              sceneImageUrls: JSON.stringify(images.sceneImageUrls),
              detailImageUrls: JSON.stringify(images.detailImageUrls),
              sellingPointImageUrls: JSON.stringify(images.sellingPointImageUrls),
              detailPageUrl,
